...
dnf install doas which @critical-path-kde kde-gtk-config sddm-kcm steam lutris librewolf discord alacritty kde-connect ufw kde-partitionmanager protontricks kate thunderbird mangohud gamemode goverlay wget sddm-breeze --exclude=konsole && \
